...
export default {
  ...
  methods: {
    submitForm() {
      const {className,userId,username,password,checkPass,mobileId} = this;
      this.$store.dispatch('userRegister',{className,userId,username,password,checkPass,mobileId});
    },
    resetForm(formName) {
