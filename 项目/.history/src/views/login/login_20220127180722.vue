  ...
  <div class="box">
    <div class="contain">
      ...
      >
        ...
        <el-form-item label="密码" id="one" prop="password" :rules="{
            required: true,
            message: '密码不能为空',
            trigger: 'blur',
          }">
        ...
        >
          <el-input v-model="loginForm.checkNumber" id="three"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button
            type="primary"
...
export default {
  ...
  methods: {
    async submitForm(formName) {
      try {
        const { userId: id, password: password, captcha: address } = this;
    ...
    //   this.address = 'http://120.77.42.192:9090/account/captcha?time' + Date.now();
    // }
  },
};
</script>
