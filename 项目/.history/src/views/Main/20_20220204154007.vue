<template>
  <div class="box">
    <div class="contain">
      账号：<el-input v-model="this.ruleForm.userId" :disabled="true"></el-input><br>
      用户名：<el-input v-model="this.ruleForm.username" :disabled="true"></el-input><br>
      电话号码：<el-input v-model="this.ruleForm.mobileId" :disabled="true"></el-input><br>
      学校：<el-input v-model="this.ruleForm.college" :disabled="true"></el-input><br>
      预约次数：<el-input v-model="this.ruleForm.orderCount" :disabled="true"></el-input><br>
      爽约次数：<el-input v-model="this.ruleForm.breakCount" :disabled="true"></el-input><br>
    </div>
    <div class="button">
