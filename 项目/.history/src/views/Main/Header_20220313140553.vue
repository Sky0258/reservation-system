...
export default {
  data() {
    return {
      ulList: [
        { title:"123",msg: '这是第一条信息' },
        { title:"123",msg: '这是第二条信息' },
        { title:"123",msg: '这是第三条信息' },
        { title:"123",msg: '这是第四条信息' },
        { title:"123",msg: '这是第五条信息' },
        { title:"123",msg: '这是第六条信息' },
        { title:"123",msg: '这是第七条信息' },
        { title:"123",msg: '这是第八条信息' },
        { title:"123",msg: '这是第九条信息' },
        { title:"123",msg: '这是第十条信息' }
      ],
      play: false
    }
  },
