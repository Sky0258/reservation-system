  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click="giveRole"
            >修改信息</el-button
          >
    ...
    >
      ...
      <el-button type="primary" @click="submitForm1('ruleForm1')" style="margin-top: 20px"
        >修改角色</el-button
      >
      <el-button @click="dialogVisible2 = false" style="margin-top: 20px">取消</el-button>
    </el-dialog>
    <el-pagination
      class="footer"
...
export default {
  ...
  methods: {
    ...
    giveRole(){
      this.$store
        .dispatch("giveRole", {
          managerId: this.userInfo.data.userId,
