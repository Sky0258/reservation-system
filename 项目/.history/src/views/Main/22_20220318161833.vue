<template>
  <div>
    ...
    <el-descriptions-item label="ID">{{this.tableData.userId}}</el-descriptions-item>
    <el-descriptions-item label="用户名">{{this.tableData.username}}</el-descriptions-item>
    <el-descriptions-item label="用户角色">苏州市</el-descriptions-item>
