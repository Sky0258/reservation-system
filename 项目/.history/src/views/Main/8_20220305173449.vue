<template>
  <div>
    <div class="images">
      ...
      <el-carousel :interval="10000" type="card" height="150px" indicator-position="outside">
        <el-carousel-item v-for="item in allSite.data.list" :key="item" style="width: 400px;margin-left: 55px">
          <img :src="item.imgUrl" alt="" style="margin: 0px;width: 400px">
...
<el-button type="primary" icon="el-icon-caret-right" @click="showstep(2)">第三页</el-button>
    ...
    <el-tabs type="border-card">
      <el-tab-pane :label="day1">
        ...
        <div class="ground">
          <el-radio v-model="radioA" label="1">篮球场地1</el-radio>
          <el-radio v-model="radioA" label="2">篮球场地2</el-radio>
          <el-radio v-model="radioA" label="3">篮球场地3</el-radio>
          <el-radio v-model="radioA" label="4">篮球场地4</el-radio>
          <el-button
            type="primary"
            plain
            style="float=right"
