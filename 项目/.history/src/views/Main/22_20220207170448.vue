<template>
  <div>
    ...
    >
      ...
      <el-table-column label="学校" prop="college" align="center" width="100px"> </el-table-column>
      <el-table-column label="班级" prop="className" align="center" width="100px"> </el-table-column>
