    ...
    >
      ...
      >
        ...
        <el-form-item label="班级" prop="className">
          <el-input v-model.number="ruleForm.className"></el-input>
        </el-form-item>
        ...
        <el-form-item label="预约次数" prop="orderCount">
          <el-input v-model.number="ruleForm.orderCount"></el-input>
        </el-form-item>
        <el-form-item label="违约次数" prop="breakCount">
          <el-input v-model.number="ruleForm.breakCount"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submitForm('ruleForm')"
            >提交</el-button
