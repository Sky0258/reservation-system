<template>
  <div>
    <el-carousel :interval="4000" type="card"  ref="carousel"
        arrow="always"
        trigger="click" height="200px" style="margin-bottom: 50px">
    <el-carousel-item  v-for="(item, index) in allSite.data.list"
          :key="item.index"
          style="width: 350px; margin-left: 82px;height: 200px">
      <img :src="item.imgUrl" style="margin: 0px;width: 350px;height: 200px">
    </el-carousel-item>
  </el-carousel>
