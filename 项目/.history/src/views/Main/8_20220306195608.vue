  ...
  methods: {
    ...
    result(city) {
      for(let index in this.ordered.data){
        ...
        // console.log(this.time4[1].substr(0,5));
        console.log('' + this.time4[1].substr(0,5) + ' ~ ' + this.time5[1].substr(0,5));
        if (this.day1 == this.time4[0] && city == '' + this.time4[1].substr(0,5) + ' ~ ' + this.time5[1].substr(0,5)) {
        return true;
      }
      }
    },
