<template>
  <div>
    ...
    <el-descriptions-item label="ID">{{this.ruleForm1.userId}}</el-descriptions-item>
    <el-descriptions-item label="用户名">{{this.ruleForm1.username}}</el-descriptions-item>
    <el-descriptions-item label="用户角色">{{this.roleName}}</el-descriptions-item>
...
export default {
  ...
  computed: {
    ...mapGetters(["userInfo", "managerInfo","role"]),
  },
};
</script>
