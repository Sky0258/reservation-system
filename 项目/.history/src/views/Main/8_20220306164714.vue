    ...
    <div class="images">
      ...
      >
        <el-carousel-item
          ...
          :key="item.index"
          style="width: 350px; margin-left: 82px"
        >
...
export default {
  ...
  methods: {
    ...
    result(city) {
      if (this.day1 == "2022-03-06（今日）" && city == "7:00 ~ 9:00") {
        return true;
      }
      return false;
    },
    submitForm1(formName) {
      ...
      if(this.day == 0){
        endedTime1 = this.ShowDate(0) + ' ' + this.time1[0] + ':00';
        startedTime1 = this.ShowDate(0) + ' ' + this.time1[1] + ':00';
      } else if(this.day == 1){
        endedTime1 = this.ShowDate(-1) + ' ' + this.time2[0] + ':00';
        startedTime1 = this.ShowDate(-1) + ' ' + this.time2[1] + ':00';
      } else{
        endedTime1 = this.ShowDate(-2) + ' ' + this.time3[0] + ':00';
        startedTime1 = this.ShowDate(-2) + ' ' + this.time3[1] + ':00';
      }
      // let userId = this.userInfo.data.userId;
      // let data = {
      //   endedTime: "2022-03-17 10:10:10",
      //   siteId: 2,
      //   siteName: "篮球场2",
      //   startedTime: "2022-03-16 10:10:10",
      //   userId: 202041412101,
      //   username: "小明",
      // };
      // this.$store
      ...
      //     this.$message.error("错误");
      //   });
      console.log(this.time1[0] + ":00");
      console.log(this.time1[1] + ":00");
    },
    show() {
      console.log(7777777);
      this.$message({
