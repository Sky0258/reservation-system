<template>
  <div>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible3" width="30%">
      ...
      <span slot="footer">
        <el-button @click="dialogVisible3 = false" style="margin-right: 10px">取 消</el-button>
        <el-button type="primary" @click="deleteRole" style="margin-right: 100px">确 定</el-button>
      </span>
    </el-dialog>
    <el-pagination
      class="footer"
