<template>
  <div>
    ...
    <el-radio v-model="radio2" label="1" border size="medium" @change="handleCheckedCitiesChange">场地预约记录</el-radio>
    <el-radio v-model="radio2" label="2" border size="medium" @change="handleCheckedCitiesChange">器材预约记录</el-radio>
