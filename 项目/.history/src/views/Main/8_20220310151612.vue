      ...
      <el-tab-pane :label="day2">
        <div>
          <el-radio-group v-model="radio2">
            <el-radio-button
              :disabled="result1(city,day2,radioA)"
              class="contain"
              v-for="city in cities"
              :label="city"
              :key="city"
        ...
        <div>
          <el-radio-group v-model="radio3">
            <el-radio-button
              class="contain"
              v-for="city in cities"
              :disabled="result1(city,day3,radioA)"
              :label="city"
              :key="city"
              >{{ city }}</el-radio-button
            >
...
export default {
  ...
  methods: {
    ...
    result1(city,day3,radioA){},
    result(city,day,radio) {
      let a = 0;
      console.log('1');
      let length = this.ordered.data.length;
      console.log(this.ordered.data[1].startedTime);
      for(const index in length){
        this.nowDay = this.ordered.data[index].startedTime;
        this.nowDay1 = this.ordered.data[index].endedTime;
        console.log(this.nowDay1);
