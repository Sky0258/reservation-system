<template>
  <div class="box">
    ...
    <div class="textBox" style="width: 700px; float: left; margin: 17px 0px">
      <transition name="slide">
        <p class="text" :key="text.id" style="width: 700px">
          <el-tag type="warning" style="height: 22px;line-height: 22px">天气情况</el-tag>
          {{ text.val }}</p>
      </transition>
    </div>
    <div class="right">
