    ...
    <el-dialog title="预约信息" :visible.sync="dialogVisible" width="30%">
      <el-descriptions column='1' style="margin-top:-15px">
        ...
        <el-descriptions-item label="预约场地">
          <el-tag size="medium">{{"" + "篮球场" + (this.radioA - 1)}}</el-tag>
        </el-descriptions-item>
      </el-descriptions>
      <el-button @click="dialogVisible = false" style="margin-top: 10px;margin-right: 20px">取 消</el-button>
      <el-button type="primary" @click="submitForm1('ruleForm1')" style="margin-top: 10px">确 定</el-button>
    </el-dialog>
  </div>
</template>
