<template>
  <div>
    <div class="contain">
      <!-- 账号：<el-input v-model="this.ruleForm.userId" :disabled="true"> -->
      用户名：<el-input v-model="this.ruleForm.username" :disabled="true">
      电话号码：<el-input v-model="this.ruleForm.mobileId" :disabled="true">
      <!-- 学校：<el-input v-model="this.ruleForm.college" :disabled="true"> -->
      <!-- 预约次数：<el-input v-model="this.ruleForm.orderCount" :disabled="true">
      爽约次数：<el-input v-model="this.ruleForm.breakCount" :disabled="true"> -->
</el-input>
    </div>
    <div class="button">
