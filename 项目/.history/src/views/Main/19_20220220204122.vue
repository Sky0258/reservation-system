<template>
  <div>
    ...
    <el-radio v-model="radio2" label="1" border size="medium" @change="handleCheckedCitiesChange">器材预约记录</el-radio>
    <el-radio v-model="radio2" label="2" border size="medium" @change="handleCheckedCitiesChange">场地预约记录</el-radio>
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="数量" prop="count" width="80px" align="center" v-if="labelName == '器材名称'">
      </el-table-column>
