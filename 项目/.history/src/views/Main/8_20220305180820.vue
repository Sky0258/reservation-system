  ...
  <div>
    ...
    <el-tabs type="border-card">
      <el-tab-pane :label="day1">
        ...
        <div class="ground">
          <el-radio v-model="radioA" :label="item.id" v-for="item in allSite.data.list" :key="item" @change="showstep(item.id)">{{item.name}}</el-radio>
          <!-- <el-radio v-model="radioA" label="2" @change="showstep(1)">篮球场地2</el-radio>
          <el-radio v-model="radioA" label="3" @change="showstep(2)">篮球场地3</el-radio>
          <el-radio v-model="radioA" label="4" @change="showstep(3)">篮球场地4</el-radio> -->
          <el-button
            type="primary"
            plain
            style="float=right"
