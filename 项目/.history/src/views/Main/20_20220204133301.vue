<template>
  <div>
    <div class="contain">
      <!-- 账号：<el-input v-model="this.ruleForm.userId" :disabled="true"></el-input> -->
      <!-- 用户名：<el-input v-model="this.ruleForm.username" :disabled="true"></el-input>
      电话号码：<el-input v-model="this.ruleForm.mobileId" :disabled="true"></el-input>
      学校：<el-input v-model="this.ruleForm.college" :disabled="true"></el-input>
      预约次数：<el-input v-model="this.ruleForm.orderCount" :disabled="true"></el-input>
      爽约次数：<el-input v-model="this.ruleForm.breakCount" :disabled="true"></el-input> -->
    ...
    <div class="button">
      ...
      >
        ...
        >
          ...
          >
            <el-input v-model="ruleForm.roleList.username"></el-input>
          </el-form-item>
          <el-form-item
            label="班级"
            prop="className"
