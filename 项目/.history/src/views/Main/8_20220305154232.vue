  ...
  <div>
    <div class="images">
      ...
      <el-carousel :interval="10000" type="card" height="150px">
        <el-carousel-item v-for="item in allSite.data.list" :key="item">
          <img src="http://120.77.42.192:9000/bucket01/2022/02/04/3b5a13a7-d41c-4f61-9550-2de92543a899.jpg" alt="">
...
export default {
  ...
  methods: {
    submitForm1(formName) {
      ...
      console.log(this.allSite.data.list);
    },
    show() {
      console.log(7777777);
      this.$message({
