    ...
    >
      ...
      <el-table-column align="center">
        ...
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-s-order" size="small" @click="showNotice(scope.row)">详情</el-button>
...
export default {
  ...
  methods: {
    ...
    showNotice(row){
      this.$store
      .dispatch("Notice", row.id)
      .then(() => {
        this.$alert( this.notice.content, row.title, {
