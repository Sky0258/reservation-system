    ...
    routes:[
        ...
        },
        {
            ...
            children: [
                ...
                { path: '/3', component: three,meta: {
                    title: "器材预约"
                }},
                { path: '/7', component: seven,meta: {
                    title: "公告栏管理"
                },},
                { path: '/8', component: eight,meta: {
                    title: "篮球场"
                }},
                { path: '/9', component: nine,meta: {
                    title: "羽毛球场"
                }},
                { path: '/10', component: ten,meta: {
                    title: "乒乓球场"
                }},
                { path: '/20', component: selfInfo,meta: {
                    title: "个人信息"
                },},
                { path: '/19', component: nineteen,meta: {
                    title: "预约记录"
                },},
                { path: '/21', component: twentyOne,meta: {
                    title: "用户信息"
                },},
                { path: '/22', component: twentyTwo,meta: {
                    title: "管理员信息"
                },},
                { path: '/23', component: twentyThree,meta: {
                    title: "场地订单"
                },},
                { path: '/24', component: twentyFour,meta: {
                    title: "器材订单"
                },},
                { path: '/25', component: twentyFive,meta: {
                    title: "场地管理"
                },},
                { path: '/26', component: twentySix,meta: {
                    title: "器材管理"
                },}
            ]
        },
