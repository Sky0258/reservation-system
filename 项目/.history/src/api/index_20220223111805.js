...
//获取所有场地
export const reqAllSite = (userId,categoryId)=>requests({url:`/${userId}/site/${categoryId}`,method:"get"})   //这里要是分页的话要加数据data!!! parmas:data

//管理员删除场地
export const reqDeleteSite = (userId,siteId)=>requests({url:`/${userId}/site/${siteId}`,method:"get"})