...
//获取所有角色
export const reqAllRoles = (userId)=>requests({url:`/api/role/${userId}`,method:"get"});
...
//给角色赋值菜单
export const reqGiveRoleMenu = (userId,roleId,menuIdList)=>requests({url:`/api/role-menu/${userId}/${roleId}`,params:menuIdList,method:"POST"});
